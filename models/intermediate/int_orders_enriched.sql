select  
    ...
    , case when o.order_shipped_at < '2500-01-01' then oi.ordered_quantity else 0 end as shipped_order_product_quantity
    , case when o.order_shipped_at = '2500-01-01' then oi.ordered_quantity else 0 end as pending_order_product_quantity
